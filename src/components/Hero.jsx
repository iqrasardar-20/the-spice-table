  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-6">
        ...
        >
          <button className="bg-yellow-500 hover:bg-yellow-400 text-black font-semibold px-10 py-4 rounded-full transition-all duration-300 hover:scale-105 shadow-lg shadow-yellow-500/30">
            View Menu
          </button>

          <button className="border-2 border-yellow-500 text-white hover:bg-yellow-500 hover:text-black font-semibold px-10 py-4 rounded-full transition-all duration-300 hover:scale-105">
            Reserve Now
          </button>
        </motion.div>
        ...
        >
          <div>
            <h2 className="text-yellow-500 text-4xl font-bold">15+</h2>
            <p className="text-gray-300 mt-2">Years Experience</p>
          </div>

          <div>
            <h2 className="text-yellow-500 text-4xl font-bold">50K+</h2>
            <p className="text-gray-300 mt-2">Happy Customers</p>
          </div>

          <div>
            <h2 className="text-yellow-500 text-4xl font-bold">120+</h2>
            <p className="text-gray-300 mt-2">Premium Dishes</p>
          </div>
        </motion.div>
